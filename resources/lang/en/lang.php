...
',
  ...
  'The reason cancel field is required when booking status is canceled.' => 'The reason cancel field is required when booking status is canceled.',
  'The card number has already been taken.' => 'The card number has already been taken.',
  'commission to Admin from each booking. You will get access of all the features and options  in provider panel , app and interaction with user.' => 'Commission to Admin from each booking. You will get access of all the features and options  in provider panel , app and interaction with user.',
  ...
  'happen error doing register' => 'Happen error doing register',
  ...
  'your_subscription_package_does_not_include_mobile_app' => 'Your subscription package does not include mobile app',
