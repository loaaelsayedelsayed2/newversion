                                    ...
                                    <tbody>
                                        @foreach ($reviews as $bookingId => $review)
                                                    ...
                                                    <td colspan="9">
                                                        <table class="table align-middle">
                                                            @foreach ($review->reviews as $key => $providerReview)
                                                                <tr>
                                                                    <td></td>
                                                                    <td>{{ $providerReview->readable_id == 0 ? 'N/A' : $providerReview->readable_id }}
                                                                    </td>
                                                                    ...
                                                                    <td data-bs-custom-class="review-tooltip"
                                                                        data-bs-toggle="tooltip"
                                                                        title="{{ $providerReview->review_comment }}">
                                                                        {{ Str::limit($providerReview->review_comment, 100) ?? translate('No review yet') }}
                                                                    </td>
                                                                    <td data-bs-custom-class="review-tooltip"
                                                                        data-bs-toggle="tooltip"
                                                                        title="{{ $providerReview->reviewReply?->reply }}">
                                                                        {{ Str::limit($providerReview->reviewReply?->reply, 100) ?? translate('No reply yet') }}
                                                                    </td>
                                                                    <td>
                                            ...
                                            @else
                                                ...
                                                <tr>
                                                    <td>{{ $bookingId + $reviews?->firstItem() }}</td>
                                                    <td>{{ $getReview->readable_id == 0 ? 'N/A' : $getReview->readable_id }}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td data-bs-custom-class="review-tooltip" data-bs-toggle="tooltip"
                                                        ...
                                                        {{ Str::limit($getReview->review_comment, 100) ?? translate('No review yet') }}
                                                    </td>
                                                    <td data-bs-custom-class="review-tooltip" data-bs-toggle="tooltip"
                                                        data-bs-placement="top"
                                                        title="{{ $getReview->reviewReply?->reply }}">
                                                        {{ Str::limit($getReview->reviewReply?->reply, 100) ?? translate('No reply yet') }}
                                                    </td>
                                                    <td>
