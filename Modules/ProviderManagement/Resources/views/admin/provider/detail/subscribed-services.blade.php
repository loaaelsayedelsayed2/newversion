...
<<<<<<< HEAD
                                            ...
                                            <tbody>
                                                @foreach ($subCategories as $sub_category)
                                                    <tr>
                                                        <td>
                                                            <div data-bs-toggle="modal" data-bs-target="#showServiceModal">
                                                                {{ Str::limit($sub_category->sub_category ? $sub_category->sub_category->name : '', 30) }}
                                                            </div>
                                                        </td>
                                                        <td>{{ $sub_category->sub_category ? $sub_category->sub_category->services_count : 0 }}
                                                        </td>
                                                        <td>
