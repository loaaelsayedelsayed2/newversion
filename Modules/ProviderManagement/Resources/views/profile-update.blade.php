                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-30">
                                            ...
                                            <input
                                                ...
                                                type="tel" class="form-control company_phone phone-input-with-country-picker iti__tel-input"
    ...
    <script>
        ...
        try {
            initializePhoneInput(
                ".phone-input-with-country-picker99",
                ".country-picker-phone-number99"
            );
            initializePhoneInput(
                ".phone-input-with-country-picker100",
                ".country-picker-phone-number100"
            );
        } catch (error) {
            console.log(error)
        }
